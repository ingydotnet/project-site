...
Looking to quickly add Bootstrap to your project? Use BootstrapCDN, provided for free by the folks at StackPath. Using a package manager or need to download the source files? [Head to the downloads page]({{ site.baseurl }}/doc/getting-started/download/).
...
Include everything you need in one script with our bundle. Our `bootstrap.bundle.js` and `bootstrap.bundle.min.js` include [Popper](https://popper.js.org/), but not [jQuery](https://jquery.com/). For more information about what's included in Bootstrap, please see our [contents]({{ site.baseurl }}/doc/getting-started/contents/#precompiled-bootstrap) section.
...
That's all you need for overall page requirements. Visit the [Layout docs]({{ site.baseurl }}/doc/layout/overview/) to start laying out your site's content and components.
...
For improved cross-browser rendering, we use [Reboot]({{ site.baseurl }}/doc/content/reboot/) to correct inconsistencies across browsers and devices while providing slightly more opinionated resets to common HTML elements.
