...
- Compiled and minified CSS bundles (see [CSS files comparison]({{ site.baseurl }}/doc/getting-started/contents/#css-files))
...
Should you require [build tools]({{ site.baseurl }}/doc/getting-started/build-tools/#tooling-setup), they are included for developing Bootstrap and its docs, but they're likely unsuitable for your own purposes.
